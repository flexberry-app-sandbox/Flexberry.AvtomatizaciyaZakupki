...
moduleForModel('i-i-s-avtomatizaciya-zakupki-номенклатура', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupki-номенклатура', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupki-номенклатура',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
