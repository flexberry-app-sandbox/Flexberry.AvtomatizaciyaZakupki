...
moduleForModel('i-i-s-avtomatizaciya-zakupki-заказ-пост', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupki-заказ-пост', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupki-заказ-пост',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
