...
moduleForModel('i-i-s-avtomatizaciya-zakupki-организации', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupki-организации', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupki-организации',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
