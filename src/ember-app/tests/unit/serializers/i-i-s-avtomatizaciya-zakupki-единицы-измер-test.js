...
moduleForModel('i-i-s-avtomatizaciya-zakupki-единицы-измер', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupki-единицы-измер', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupki-единицы-измер',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
