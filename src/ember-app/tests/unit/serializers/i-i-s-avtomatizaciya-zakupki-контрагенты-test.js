...
moduleForModel('i-i-s-avtomatizaciya-zakupki-контрагенты', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupki-контрагенты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupki-контрагенты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
