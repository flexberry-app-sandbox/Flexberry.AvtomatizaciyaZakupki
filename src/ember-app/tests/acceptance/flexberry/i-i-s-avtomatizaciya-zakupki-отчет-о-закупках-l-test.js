...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki отчет о закупках l');

test('testing i-i-s-avtomatizaciya-zakupki-отчет-о-закупках-l', function(assert) {
