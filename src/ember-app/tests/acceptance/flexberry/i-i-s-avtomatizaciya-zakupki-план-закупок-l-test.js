...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki план закупок l');

test('testing i-i-s-avtomatizaciya-zakupki-план-закупок-l', function(assert) {
