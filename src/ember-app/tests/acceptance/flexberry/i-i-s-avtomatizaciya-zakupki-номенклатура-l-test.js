...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki номенклатура l');

test('testing i-i-s-avtomatizaciya-zakupki-номенклатура-l', function(assert) {
