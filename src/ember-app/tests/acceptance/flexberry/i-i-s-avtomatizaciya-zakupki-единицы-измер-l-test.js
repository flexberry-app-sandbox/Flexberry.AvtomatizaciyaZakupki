...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupki единицы измер l');

test('testing i-i-s-avtomatizaciya-zakupki-единицы-измер-l', function(assert) {
