...
namespace IIS.Avtomatizaciya_zakupki
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupki.Номенклатура fНоменклатура;
        
        private IIS.Avtomatizaciya_zakupki.ЗаказПост fЗаказПост;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Avtomatizaciya_zakupki.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupki.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Avtomatizaciya_zakupki.ЗаказПост.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Avtomatizaciya_zakupki.ЗаказПост",
                "IIS.Avtomatizaciya_zakupki.ОтчетОЗакупках"})]
        public virtual IIS.Avtomatizaciya_zakupki.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupki.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Avtomatizaciya_zakupki.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupki.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupki.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Avtomatizaciya_zakupki.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupki.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupki.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupki.ТЧЗаказ dataobject)
        {
