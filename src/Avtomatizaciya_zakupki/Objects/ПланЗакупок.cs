...
namespace IIS.Avtomatizaciya_zakupki
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupki.DetailArrayOfПлан fплан;
        ...
        public virtual IIS.Avtomatizaciya_zakupki.DetailArrayOfПлан план
        {
            get
            {
                ...
                if ((this.fплан == null))
                {
                    this.fплан = new IIS.Avtomatizaciya_zakupki.DetailArrayOfПлан(this);
                }
                IIS.Avtomatizaciya_zakupki.DetailArrayOfПлан result = this.fплан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.Avtomatizaciya_zakupki.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.Avtomatizaciya_zakupki.ПланЗакупок));
                }
            }
        }
    }
