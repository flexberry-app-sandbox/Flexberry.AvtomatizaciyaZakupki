...
namespace IIS.Avtomatizaciya_zakupki
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupki.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Avtomatizaciya_zakupki.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Avtomatizaciya_zakupki.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupki.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Avtomatizaciya_zakupki.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupki.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupki.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Avtomatizaciya_zakupki.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupki.План this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupki.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupki.План dataobject)
        {
